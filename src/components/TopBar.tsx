    ...
    <nav className='border-b border-b-gray-200 dark:bg-dark dark:border-b-dark-light px-2 sm:px-4 py-3.5'>
      <div className='container flex flex-wrap justify-between items-center mx-auto'>
        ...
        <button
          ...
          type='button'
          className='inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-orange-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-200'
